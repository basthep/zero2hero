...
import { createUser, getUnreadNotification, getUserByEmail ,markNotificationAsRead } from "@/utils/db/actions"
...
export default function Header({onMenuClick,totalEarnings}:HeaderProps){
    ...
    const [loggedeIn,setLoggedeIn]=useState(false)
    ...
    const login = async ()=> {
        if(!web3Auth){
            console.error('Web3Auth is not iniitialized')
            return;
        }
        try {
...
<input type="text"
placeholder="search...." className="w-full px-4 py-2 border-gray-300 rounded-full focus:outline-none focus:ring-2 focus:ring-green-500" />
